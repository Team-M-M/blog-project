    ...
    <div className="wrap" id="wrap">
      <div className="wrap_in">
        ...
        <div className="container">
            ...
            <div className="res_pay_area">
              <ul>
                ...
                <li>
                  ...
                  <div className="tel_area">
                    <input type="text" id="rec_rmk" name="rec_rmk" placeholder="차량번호를 입력해 주세요." className="inp_txt" />
                  </div>
                </li>
                <li>
                  <label htmlFor="tel" className="tit">
            ...
            <div className="res_pay_area">
              <div className="save_div">
                ...
                <div className="code_num">
                  <input type="text" pattern="[0-9]*" placeholder="인증번호를 입력해 주세요." className="inp_txt" />
          ...
          <Link href="/reservation/resList/detail" passHref>
            <button type="button" id="BtnAdd" className="link_fixdfull" onClick={() => 'SavResLongAdd();'}>
              예약하기
            </button>
          </Link>
        </div>
